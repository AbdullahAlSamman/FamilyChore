...
interface FamilyRepository {
    ...
    suspend fun addUserToFamily(familyId: String, nickname: String, role: org.aals.family.chore.core.domain.model.UserRole, requiresPin: Boolean = true): User
    suspend fun updateUserPinRequirement(userId: String, requiresPin: Boolean)
